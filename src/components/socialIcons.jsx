...
const SocialIcons = ()=>{
    return(
        <div className="flex gap-4">
            ...
            <a href="https://www.facebook.com/share/1DMU72kPo4/?mibextid=wwXlfr" target="_blank" className="flex duration-300 items-center py-1.5 px-2 hover:bg-purple-800 hover:text-white cursor-pointer rounded-full text-purple-600 border-2 border-purple-600">
