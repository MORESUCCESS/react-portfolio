  ...
  return (
    <>
      ...
      <section id="aboutme" className="bg-gray-300">
        <div className="w-9/11 mx-auto py-25">
          ...
          >
            ...
            <p className="mb-20 text-center lg:text-xl bg-purple-700 text-white py-1 rounded-full w-fit px-5">Few things about me and how I handle projects</p>
          </motion.div>
          ...
          <div className="mt-20">
                <p className="mb-8 text-center text-xl bg-purple-700 text-white py-1 rounded-full w-full px-5">My Tech Stacks</p>
                <motion.div className="grid lg:grid-cols-5 grid-cols-2 place-items-start gap-4 bg-white/40 p-5 rounded-xl"
                    variants={container}
                    initial="hidden"
                    whileInView="show"
                    viewport={{ once: true }}
      ...
      {/* Projects */}
      <section id="projects" className="py-25 bg-[#020618]">
        <div className="mx-auto w-9/11">
            <motion.div className="flex flex-col items-center justify-center space-y-5"
                ...
                transition={{ duration: 0.7 }}
            >
                <h1 className="text-6xl font-bold text-center text-white">Projects</h1>
                <p className="lg:mb-20 text-center lg:text-xl bg-purple-700 text-white py-1 rounded-full w-fit px-5">Here are the lists of projects I have built successfully!</p>
            </motion.div>
                        ...
                        >
                            ...
                            <div className="p-5 space-y-3">
                                ...
                                <div className="flex items-center justify-between mt-5">
                                    <button>
                                        <a href={item.live} target="_blank" className="flex gap-2 bg-purple-700 py-2 px-5 rounded-lg hover:bg-purple-500">
                                            View Project
                                            <ArrowRight/>    
                                        </a>
                                    </button>
                            ...
                            <p className="absolute top-3 left-5 bg-green-400 px-5 rounded-full">{item.status}</p>
                        </motion.div>
                    ))
                }
            </div>
      ...
      {/* Contact me */}
      <section id="contactme" className="bg-gray-300 py-20">
            ...
            >
                <div className="flex flex-col items-center justify-center space-y-5">
                    <h1 className="lg:text-6xl text-5xl font-bold text-center">Contact me</h1>
                    <p className="mb-20 text-center lg:text-xl bg-purple-700 text-white py-1 rounded-full w-fit px-5">Do you run a business brand and need a website to promote your business?</p>
                </div>
            </motion.div>
            ...
            >
                <div className="space-y-5">
                    <h1 className="text-3xl font-bold">Just a click away!</h1>
                    <p className="text-xl">Do you have any project idea at all? get in touch, let's turn your ideas into creativity!</p>

                    <div className="lg:flex hidden items-center gap-4 mt-15">
                        <Mail className="w-10 h-10 text-purple-700"/>
                        <p className="text-xl">ms2dwrld@gmail.com</p>
                    </div>
                </div>

                <div>
                    <form action="mailto:ms2dwrld@gmail.com" method="post" encType="text/plain" className="flex justify-between flex-wrap gap-3">
                        ...
                        <div>
                            <button type="submit" className="hover:bg-purple-600 bg-purple-700 text-white py-2 px-6 rounded-xl cursor-pointer active:scale-90 transition-transform duration-300">Send Message</button>
                        </div>
                    </form>
                </div>
            </motion.div>
